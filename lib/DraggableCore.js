...
export type DraggableCoreDefaultProps = {
  ...
  scale: number,
  targetWindow: null, //Add this line
};
...
export type DraggableCoreProps = {
  ...
  targetWindow?: Window, // <-- Add this line
};
...
export default class DraggableCore extends React.Component<DraggableCoreProps> {
  ...
  static propTypes: Object = {
    ...
    targetWindow: PropTypes.object, //Add this line
  ...
  componentWillUnmount() {
    ...
    if (thisNode) {
      ...
      const targetWin = this.props.targetWindow || ownerDocument.defaultView || window;
      removeEvent(targetWin.document, eventsFor.mouse.move, this.handleDrag);
      removeEvent(targetWin.document, eventsFor.touch.move, this.handleDrag);
      removeEvent(targetWin.document, eventsFor.mouse.stop, this.handleDragStop);
      removeEvent(targetWin.document, eventsFor.touch.stop, this.handleDragStop);
  ...
  handleDragStart: EventHandler<MouseTouchEvent> = (e) => {
    ...
    const targetWin =
      this.props.targetWindow || ownerDocument.defaultView || window;
    addEvent(targetWin.document, dragEventFor.move, this.handleDrag);
    addEvent(targetWin.document, dragEventFor.stop, this.handleDragStop);
  };
  ...
  handleDragStop: EventHandler<MouseTouchEvent> = (e) => {
    ...
    if (thisNode) {
      ...
      const targetWin = this.props.targetWindow || thisNode.ownerDocument.defaultView || window;

      log("DraggableCore: Removing handlers");
      removeEvent(targetWin.document, dragEventFor.move, this.handleDrag);
      removeEvent(targetWin.document, dragEventFor.stop, this.handleDragStop);
    }
  };
